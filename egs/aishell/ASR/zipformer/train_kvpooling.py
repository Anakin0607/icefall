...
from zipformer.zipformer_kvpooling import Zipformer2
...
def add_model_arguments(parser: argparse.ArgumentParser):
    ...
    parser.add_argument(
        ...
        type=str,
        default="none",
        help="Method to pooling K,V in attention. Support \"conv\" and \"avg\". ",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="1,1,1,1,1,1",
        help="Stride of pooling K and V. ",
    )
...
def get_encoder_model(params: AttributeDict) -> nn.Module:
    encoder = Zipformer2(
        ...
        pooling_stride=_to_int_tuple(params.pooling_stride),
    )
    return encoder
